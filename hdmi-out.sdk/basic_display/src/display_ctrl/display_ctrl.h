...
// Remove the old multi-frame constant
// #define DISPLAY_NUM_FRAMES 3



// Modify the initialization function signature
...
typedef struct {
    ...
    u8 *frame_ptr;              /* Pointer to the framebuffer */
    u32 stride;                 /* The line stride of the framebuffer, in bytes */
...
int DisplayInitialize(DisplayCtrl *disp_ptr, XAxiVdma *vdma, u16 vtc_id, u32 dynclk_addr, u8 *frame_ptr, u32 stride);
