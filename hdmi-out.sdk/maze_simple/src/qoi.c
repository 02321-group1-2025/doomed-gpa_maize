         ...
         default: {
            ...
            switch (tag) {
               ...
               case 0b01: {
                  ...
                  current_pixel.red = (previous_pixel.red + dr) & 0xFF;
                  current_pixel.green = (previous_pixel.green + dg) & 0xFF;
                  current_pixel.blue = (previous_pixel.blue + db) & 0xFF;
                  current_pixel.alpha = previous_pixel.alpha;
			  ...
			  case 0b10: {
				 ...
				 int8_t db_dg = (data2 & 0x0F);

				 // Apply bias of '8'
				 dr_dg -= 8;
				 db_dg -= 8;

				 int8_t diff_red = dr_dg + diff_green;
				 int8_t diff_blue = db_dg + diff_green;
